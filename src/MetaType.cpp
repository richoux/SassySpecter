...
#ifdef SC2API
MetaType::MetaType(const std::string & name, SassySpecterBot & bot)
    : MetaType()
{
    m_bot = &bot;
    m_name = name;
...
MetaType::MetaType(const BWAPI::TechType & t, SassySpecterBot & bot) 
    : m_tech(t)
...
MetaType::MetaType(const UnitType & unitType, SassySpecterBot & bot)
{
    m_bot           = &bot;
    m_type          = MetaTypes::Unit;
    m_unitType      = unitType;
...
MetaType::MetaType(const CCUpgrade & upgradeType, SassySpecterBot & bot)
{
    m_bot           = &bot;
    m_type          = MetaTypes::Upgrade;
